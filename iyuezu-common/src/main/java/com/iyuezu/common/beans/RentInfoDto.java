...
public class RentInfoDto {
	...
	private List<RentReservation> reservations; // 求租回应信息
	...
	public List<RentReservation> getReservations() {
		return reservations;
	}

	public void setReservations(List<RentReservation> reservations) {
