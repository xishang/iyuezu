...
public class User implements Serializable {
	...
	private static final long serialVersionUID = -6338891280789088195L;
	
	private String uuid; // 用户UUID,用来唯一标识该用户
	private String account; // 用户账号
	private String username; // 用户名
	private String password; // 用户密码
	private String token; // token信息，验证用户身份
	...
	private Long activeTime; // 用户最近一次请求的时间戳
	...
	public void formatDefault() {
		...
		activeTime = activeTime == null ? 0L : activeTime;
	}
